...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model_checkpoint", type=str, default="tiiuae/Falcon3-10B-Instruct", help="Hugging Face model checkpoint."
    )
    parser.add_argument("--input_file", type=str, default="trivia_qa.json", help="Path to the input JSON file.")
    parser.add_argument(
        "--output_file",
        type=str,
        default="generated_data/generation_output.json",
        help="Path to save the output JSON file.",
    )
    parser.add_argument("--n_queries", type=int, default=100, help="Number of queries to process from the input file.")
